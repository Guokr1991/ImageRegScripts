...
run("16-bit");
run("Multiply...", "value=16.000 stack");
open("ROOT_PNUM/US_PATH/ARFI_PATH/ARFI_NII");
...
run("Raw...", "open=ROOT_PNUM/loupas/BMODE_RAW image=[32-bit Real] width=737 height=370 offset=0 number=366 gap=0");
imageCalculator("Add create stack", "BMODE_RAW","Gleason 3 Outlines");
...
imageCalculator("Add create stack", "BMODE_RAW","Gleason 4 Outlines");
...
imageCalculator("Add create stack", "BMODE_RAW","Result of US_HIST_NII");
...
imageCalculator("Add create stack", "BMODE_RAW","BPH Outlines");
...
imageCalculator("Add create stack", "BMODE_RAW","Atrophy Outlines");
