run("Raw...", "open= image=[32-bit Real] width=737 height=370 offset=0 number=366 gap=0");
rename("BMODE");
run("8-bit");
open("");
rename("SegPath");
...
run("Find Edges", "stack");
run("Magenta");
run("Merge Channels...", "c1=BMODE c2=Capsule c3=[Gleason 3] c4=[Gleason 4] c5=Atrophy c6=BPH create keep");
run("Channels Tool...");
