...
def main():
    ...
    parser.add_argument("--mr_hist_path",help="Path in ROOT/PatientPNUM containing MR Histology Nifti input",default="registered/SyN1p2_NumBins32_Iters200x200x100x50")
