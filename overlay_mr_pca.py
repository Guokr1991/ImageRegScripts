...
def main():
    ...
    parser.add_argument("--mr_hist_path",help="Path in ROOT/PatientPNUM containing MR Histology Nifti input",default="registered/MI_SyN1p2_NumBins32_Iters200x200x100x50")
    parser.add_argument("--mr_hist_nii",help="MR Histology Nifti input",default="Histo_MRI_allpath_regtest_MI.nii")
    ...
    parser.add_argument("--reg_final_vol",help="path for registered final volume in ROOT/PatientPNUM",default="registered/MI_SyN1p2_NumBins32_Iters200x200x100x50/final_volumes")
