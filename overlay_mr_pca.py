'''
overlay_mr_pca.py - generate an ImageJ macro to generate overlays of PCA on MR
images from user-input variables (described using --help)
'''

__author__ = "Mark Palmeri"
__email__ = "mark.palmeri@duke.edu"
__created__ = "2013-01-20"
...
def main():
    ...
    parser.add_argument("--mr_hist_path",help="Path in ROOT/PatientPNUM containing MR Histology Nifti input",default="raw_hist_mr_capsule_test_reg/registered/MI_SyN3")
    parser.add_argument("--mr_hist_nii",help="MR Histology Nifti input",default="Histo_MRI_allpath_regtest_CC_737_370_366.nii")
    parser.add_argument("--mr_path",help="path for MR NOPHI Nifti input",default="MRI_Images")
    parser.add_argument("--mr_nophi_nii",help="MR NOPHI Nifti input",default="P65_no_PHI.nii")
    parser.add_argument("--reg_final_vol",help="path for registered final volume in ROOT/PatientPNUM",default="registered/final_volumes")
    ...
    P_IJM = open('%s/%s' % (ROOT_PNUM,IJM_TEMPLATE), 'w')
