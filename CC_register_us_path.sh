...
ANTS 3 -m CC[ $US_PATH/$US_CAPSULE,$HIST_REG_PATH/$HIST_CAPSULE,1,$RADIUS] -o $REG_PATH/$HIST_US_ANTS_MI -i $ITERS -t SyN[$SYN] -a $REG_PATH/$US_HIST_CAPSULE\Affine.txt #-r Gauss[0 3] 
