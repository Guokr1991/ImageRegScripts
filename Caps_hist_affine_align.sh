...
ANTS 2 -m MI[$HIST_PATH/$SLIDE_N_NII,$HIST_PATH/$SLIDE_N_NII,1,12] -i 0 -o $REG_PATH/$ANTS_OUTPUT --rigid-affine true
...
do
    ...
    ANTS 2 -m MI[$REG_PATH/$REG_SLIDE_NII,$HIST_PATH/$SLIDE_N_NII,1,12] -i 0 -o $REG_PATH/$ANTS_OUTPUT --rigid-affine true
